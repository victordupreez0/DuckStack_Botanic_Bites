const ShopProductCard = ({ species, name, images, description, price, stock, onClick }) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <img className="object-cover object-center w-full h-56" src={thumbnail} alt={name} />
      <div className="flex items-center px-6 py-3 bg-black">
        <h2 className="text-sm font-light text-white">{species}</h2>
      </div>
      <div className="py-4">
        <h2 className="text-lg font-semibold text-gray-800 text-black">{name}</h2>
