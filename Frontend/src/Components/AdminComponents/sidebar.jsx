  ...
  <div className="sidebar bg-gray-900 text-white w-64 h-full flex flex-col">
    ...
    <nav className="sidebar-menu flex-1 p-4">
      <ul className="space-y-2">
        <li>
          <a href="/dashboard" className="flex items-center p-2 rounded hover:bg-gray-800 transition-colors gap-3">
        ...
        <li>
          <a href="/products" className="flex items-center p-2 rounded hover:bg-gray-800 transition-colors gap-3">
        ...
        <li>
          <a href="/orders" className="flex items-center p-2 rounded hover:bg-gray-800 transition-colors gap-3">
        ...
        <li>
          <a href="/users" className="flex items-center p-2 rounded hover:bg-gray-800 transition-colors gap-3">
