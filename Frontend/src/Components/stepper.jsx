...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#000000ff', color: '#ffffffff' },
          active: { scale: 1, backgroundColor: '#A07856', color: '#7b5a3dff' },
          complete: { scale: 1, backgroundColor: '#A07856', color: '#be9673ff' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#805e40ff' }
  };
